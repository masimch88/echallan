                ...
                <div class="container-fluid dashboard-content ">
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Select Date and Account of Challan</h5>
                                    <div class="card-body">
                                        <form id="form" data-parsley-validate="" novalidate=" " method="post"  action="functions/addempf.php">
                                        <div class="form-group row">
                                                <label for="inputPassword2" class="col-3 col-lg-2 col-form-label text-right">Challan A/C</label>
                                                <div class="col-9 col-lg-10">
                                                    <input id=""  name="email" type="text" required="" placeholder="example FA17" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword2" class="col-3 col-lg-2 col-form-label text-right">Starting Date</label>
                                                <div class="col-9 col-lg-10">
                                                    <input id=""  name="email" type="text" required="" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword2" class="col-3 col-lg-2 col-form-label text-right">Ending Ending</label>
                                                <div class="col-9 col-lg-10">
                                                    <input id=""  name="email" type="text" required="" placeholder="" class="form-control">
                                                </div>
                                            </div>
