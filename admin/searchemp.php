                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                      <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                          ...
                                          <label>Search:
                                              <input type="search" name="search" class="form-control form-control-sm" placeholder="" aria-controls="example"></label>
                                    ...
                                    if(isset($_POST['submit']))
                                    {
                                      ...
                                      $id=$_POST['search'];
                                      $sql="select * from user, dept, employee where employee.emp_id=user.user_id AND dept.dept_id=user.udept_id AND user_id='$id'";
